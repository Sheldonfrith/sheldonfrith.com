...
export type SortingAlgorithmReadable = typeof sortingAlgorithmNames[keyof typeof sortingAlgorithmNames];
export type SortingAlgorithmName = keyof typeof sortingAlgorithmNames;

export function getInitializedSorters(emscriptenQuickSortModule: any, emscriptenCountSortModule: any): Record<SortingAlgorithmName, SortingAlgorithm>{
    return {
