...
export type CPPNumTypeName = typeof dataTypeNamesToCPPTypeNames[keyof typeof dataTypeNamesToCPPTypeNames];
export type JsDataTypeArray = Int8Array | Int16Array | Int32Array | Float32Array | Float64Array; 
...
type JsDataTypeArrayConstructor = typeof dataTypeNamesToJsArrayTypeConstructors[keyof typeof dataTypeNamesToJsArrayTypeConstructors];
...
const dataTypeNamesToEmscriptenModuleBuffer: Record<DataTypeName,EmscriptenModuleBufferName> = {
    int16: "HEAP16",
    int32: "HEAP32",
    float32: "HEAPF32",
    float64: "HEAPF64"
...
export type DataTypeReadableName = typeof dataTypeNamesToReadableNames[keyof typeof dataTypeNamesToReadableNames];
...
export class ArrayGenerator {
    ...
    private randomValueFromInterval(dataType:DataTypeName, min:number, max:number) { // min and max included 
    ...
    private setUpCArrays(arrayLength: number, modules: CArrays, values: JsDataTypeArray, dataType: DataTypeName):
    ...
    private setUpCArray(arrayLength: number, module: any, values: JsDataTypeArray, dataType: DataTypeName, moduleName: CArrayDefNames): CArrayDef {
        ...
        const bufferName: EmscriptenModuleBufferName = NumberDataTypes[dataType].emscriptenBufferKey;
