...
var sortingAlgorithms = (() => {
  var _scriptDir = "wasm/sortingAlgorithms.wasm";

  return function (sortingAlgorithms) {
    sortingAlgorithms = sortingAlgorithms || {};

    var Module =
      typeof sortingAlgorithms != "undefined" ? sortingAlgorithms : {};
    ...
    if (Module["locateFile"]) {
      wasmBinaryFile = "wasm/sortingAlgorithms.wasm";
      wasmBinaryFile = "wasm/sortingAlgorithms.wasm";
    } else {
      wasmBinaryFile = "wasm/sortingAlgorithms.wasm";
    }
    ...
    var _countSort = (Module["_countSort"] = function () {
      return (_countSort = Module["_countSort"] = Module["asm"]["n"]).apply(
        null,
        arguments
      );
    });
    ...
    var _quickSort = (Module["_quickSort"] = function () {
      return (_quickSort = Module["_quickSort"] = Module["asm"]["o"]).apply(
        null,
        arguments
      );
    });
