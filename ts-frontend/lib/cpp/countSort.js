var countSort = (() => {
  ...
  return function (countSort) {
    countSort = countSort || {};

    var Module = typeof countSort != "undefined" ? countSort : {};
    ...
    if (Module["locateFile"]) {
      wasmBinaryFile = "countSort.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("countSort.wasm", import.meta.url).toString();
    }
