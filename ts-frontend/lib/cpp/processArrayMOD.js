...
var processArray = (() => {
  var _scriptDir = "wasm/processArray.wasm";
  
  return (
function(processArray) {
  processArray = processArray || {};

var Module = typeof processArray != "undefined" ? processArray : {};
...
if (Module["locateFile"]) {
wasmBinaryFile = 'wasm/processArray.wasm';
wasmBinaryFile = 'wasm/processArray.wasm';
} else {
wasmBinaryFile = 'wasm/processArray.wasm';
}
...
var _processArray = Module["_processArray"] = function() {
 return (_processArray = Module["_processArray"] = Module["asm"]["n"]).apply(null, arguments);
};
