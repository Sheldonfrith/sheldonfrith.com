var quickSort = (() => {
  ...
  return function (quickSort) {
    quickSort = quickSort || {};

    var Module = typeof quickSort != "undefined" ? quickSort : {};
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("quickSort.wasm", import.meta.url).toString();
    }
