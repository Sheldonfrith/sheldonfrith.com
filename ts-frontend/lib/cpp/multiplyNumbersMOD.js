...
var multiplyNumbers = (() => {
  var _scriptDir = "wasm/multiplyNumbers.wasm";

  return function (multiplyNumbers) {
    multiplyNumbers = multiplyNumbers || {};

    var Module = typeof multiplyNumbers != "undefined" ? multiplyNumbers : {};
    ...
    if (Module["locateFile"]) {
      wasmBinaryFile = "wasm/multiplyNumbers.wasm";
      wasmBinaryFile = "wasm/multiplyNumbers.wasm";
    } else {
      wasmBinaryFile = "wasm/multiplyNumbers.wasm";
    }
    ...
    var _multiplyNumbers = (Module["_multiplyNumbers"] = function () {
      return (_multiplyNumbers = Module["_multiplyNumbers"] =
