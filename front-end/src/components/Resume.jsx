...
export default function Reume(props) {
  ...
  return (
    <div className="resume">
      ...
      been programming for years, but only recently decided to pursue it seriously as a career.</p>
        ...
        <Accordian>
          ...
          <div>
            <a href="/SheldonFrithResume.docx"><button>Download As Word File</button></a>
          </div>
          <div>
            <a href="/SheldonFrithResume.pdf"><button>Download As PDF</button></a>
          </div>
          <div>
            <a href="/SheldonFrithResume.html"><button>Download As HTML</button></a>
          </div>
          </div>
    ...
    sharp.</p>
          ...
          <div className="workHistory" label="Work History" style={{ display: 'flex', flexDirection: 'column' }}>
